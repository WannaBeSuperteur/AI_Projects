...
| LLM Fine-tuning 학습 데이터 생성                  | 03.15 토 (1d)           | ```P001-003-Data```      | ⬜  |
| LLM Fine-tuning 실시 (SFT)                   | 03.15 토 (1d)           | ```P001-004-FineTune```  | ⬜  |
| LLM Fine-tuning 실시 (ORPO)                  | 03.15 토 (1d)           | ```P001-004-FineTune```  | ⬜  |
