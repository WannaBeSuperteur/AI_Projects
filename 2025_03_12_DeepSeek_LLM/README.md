...
* 전체 일정 : **2025.03.12 수 - 03.26 수 (15d)**
...
| CNN 개발 및 학습                                  | 03.23 일 - 03.24 월 (2d) | ```P001-008-CNN```             | ✅  |
| Auto-Encoder 개발 및 학습                         | 03.25 화 - 03.26 수 (2d) | ```P001-009-AE```              | ✅  |
| k-NN 개발 및 학습                                 | 03.26 수 (1d)           | ```P001-010-kNN```             | ✅  |
| 기본 가독성 + 예상 사용자 평가 점수 처리 알고리즘 개발             | 03.26 수 (1d)           | ```P001-011-Score```           | ✅  |
| 전체 기능 실행 코드 개발 (사용자 실행용)                     | 03.26 수 (1d)           | ```P001-012-ForUser```         | 💨 |
| 프로젝트 상세 설명 정리 및 링크 추가                        | 03.26 수 (1d)           |                                | ⬜  |
