...
| LLM Fine-tuning 실시 (SFT)                     | 03.17 월 (1d)           | ```P001-006-FineTune```   | ⬜  |
| LLM Fine-tuning 실시 (ORPO)                    | 03.17 월 (1d)           | ```P001-006-FineTune```   | ⬜  |
| CNN 개발 및 학습                                  | 03.17 월 (1d)           | ```P001-007-CNN```        | ⬜  |
| Auto-Encoder 개발 및 학습                         | 03.17 월 (1d)           | ```P001-008-AE```         | ⬜  |
| k-NN 개발 및 학습                                 | 03.17 월 (1d)           | ```P001-009-kNN```        | ⬜  |
| 기본 가독성 + 예상 사용자 평가 점수 처리 알고리즘 개발             | 03.18 화 (1d)           | ```P001-010-Score```      | ⬜  |
| 프로젝트 상세 설명 정리 및 링크 추가                        | 03.18 화 (1d)           |                           | ⬜  |
