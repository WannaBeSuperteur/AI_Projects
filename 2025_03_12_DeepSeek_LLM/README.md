...
| CNN 개발 및 학습                                  | 03.21 금 (1d)           | ```P001-007-CNN```        | ⬜  |
| Auto-Encoder 개발 및 학습                         | 03.21 금 (1d)           | ```P001-008-AE```         | ⬜  |
| k-NN 개발 및 학습                                 | 03.21 금 (1d)           | ```P001-009-kNN```        | ⬜  |
| 기본 가독성 + 예상 사용자 평가 점수 처리 알고리즘 개발             | 03.22 토 (1d)           | ```P001-010-Score```      | ⬜  |
