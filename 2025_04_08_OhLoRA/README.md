...
* 전체 일정 : **2025.04.08 화 - 04.18 금 (11d)**
...
| 최종 테스트 및 QA                                        | 04.18 금 (1d) |                                | ⬜  |
| 프로젝트 마무리 및 문서 정리                                   | 04.18 금 (1d) |                                | ⬜  |
...
| **(추가)** StyleGAN Generator 추가 학습 (VAE decoder idea) | 04.15 화 (1d)           | ```P002-007-Train-Gen```       | 💨 |
| Auto-Encoder 구현                                      | 04.15 화 (1d)           | ```P002-009-AE```              | ⬜  |
| k-NN 구현                                              | 04.15 화 (1d)           | ```P002-010-kNN```             | ⬜  |
...
| Unsloth 실행 시도                                      | 04.16 수 (1d)           |                            | ⬜  |
| 적절한 한국어 LLM 모델 선택                                  | 04.16 수 (1d)           |                            | ⬜  |
| SFT 학습 데이터셋 제작                                     | 04.16 수 (1d)           | ```P002-011-SFT-Dataset``` | ⬜  |
| SFT + LoRA 를 이용한 Fine-Tuning                       | 04.16 수 - 04.17 목 (2d) | ```P002-012-SFT-LoRA```    | ⬜  |
| RAG 적용                                             | 04.17 목 - 04.18 금 (2d) | ```P002-013-RAG```         | ⬜  |
