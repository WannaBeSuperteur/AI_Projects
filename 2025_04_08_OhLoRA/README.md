...
* 전체 일정 : **2025.04.08 화 - 04.24 목 (17d)**
...
| **(추가)** 사용자 실행용 코드 작성 | 04.23 수 - 04.24 목 (2d) | ```P002-014-ForUser``` | ✅  |
| 최종 테스트 및 QA            | 04.24 목 (1d)           |                        | 💨 |
| 프로젝트 마무리 및 문서 정리       | 04.24 목 (1d)           |                        | 💨 |
...
| **(추가)** Polyglot-Ko 1.3B 를 LoRA rank 128 로 학습 및 테스트                                                                                           | 04.23 수 (1d)           | ```P002-013-Polyglot-128``` | ✅  |
