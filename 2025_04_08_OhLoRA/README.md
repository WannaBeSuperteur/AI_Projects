...
* 전체 일정 : **2025.04.08 화 - 04.21 월 (14d)**
...
| 최종 테스트 및 QA          | 04.21 월 (1d) |        | ⬜  |
| 프로젝트 마무리 및 문서 정리     | 04.21 월 (1d) |        | ⬜  |
...
| **(추가)** StyleGAN Generator 추가 학습을 위한 CNN 학습                               | 04.13 일 - 04.14 월 (2d) | ```P002-007-Train-Gen```       | ✅  |
| **(추가)** StyleGAN Generator 추가 학습 (StyleGAN-FineTune-v2, CNN idea)         | 04.14 월 - 04.15 화 (2d) | ```P002-007-Train-Gen```       | ✅  |
| **(추가)** 핵심 속성 값 계산 알고리즘 개선                                                | 04.14 월 (1d)           | ```P002-008-Property```        | ✅  |
| **(추가)** StyleGAN Generator 추가 학습 (StyleGAN-FineTune-v3, VAE decoder idea) | 04.15 화 - 04.18 금 (4d) | ```P002-007-Train-Gen```       | ✅  |
| **(추가)** StyleGAN Generator 추가 학습 (StyleGAN-FineTune-v4, StyleGAN 재 학습)    | 04.18 금 - 04.20 일 (3d) | ```P002-009-StyleGAN```        | 💨 |                                                                  
...
| SFT 학습 데이터셋 제작                                                                                                                                 | 04.19 토 (1d)           | ```P002-010-SFT-Dataset``` | ✅  |
| 적절한 한국어 LLM 모델 선택 (Google Colab 에서)                                                                                                            | 04.19 토 - 04.20 일 (2d) |                            | 💨 |
| Unsloth 실행 시도                                                                                                                                  | 04.20 일 (1d)           |                            | ⬜  |
| SFT + LoRA 를 이용한 Fine-Tuning                                                                                                                   | 04.20 일 - 04.21 월 (2d) | ```P002-011-SFT-LoRA```    | ⬜  |
| LLM 의 메모리 구현 ([RAG](https://github.com/WannaBeSuperteur/AI-study/blob/main/AI%20Basics/LLM%20Basics/LLM_%EA%B8%B0%EC%B4%88_RAG.md) 와 유사한 메커니즘) | 04.21 월 (1d)           | ```P002-012-RAG```         | ⬜  |
