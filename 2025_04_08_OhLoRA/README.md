...
* 전체 일정 : **2025.04.08 화 - 04.23 수 (16d)**
...
| **(추가)** 사용자 실행용 코드 작성 | 04.22 화 (1d) |        | ⬜  |
| 최종 테스트 및 QA            | 04.23 수 (1d) |        | ⬜  |
| 프로젝트 마무리 및 문서 정리       | 04.23 수 (1d) |        | ⬜  |
...
| SFT + LoRA 를 이용한 Fine-Tuning                                                                                                                   | 04.21 월 - 04.22 화 (2d) | ```P002-011-SFT-LoRA```    | 💨 |
| LLM 의 메모리 구현 ([RAG](https://github.com/WannaBeSuperteur/AI-study/blob/main/AI%20Basics/LLM%20Basics/LLM_%EA%B8%B0%EC%B4%88_RAG.md) 와 유사한 메커니즘) | 04.22 화 (1d)           | ```P002-012-RAG```         | ⬜  |
