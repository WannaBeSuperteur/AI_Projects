...
* 전체 일정 : **2025.04.08 화 - 04.19 토 (12d)**
...
| 최종 테스트 및 QA          | 04.19 토 (1d) |        | ⬜  |
| 프로젝트 마무리 및 문서 정리     | 04.19 토 (1d) |        | ⬜  |
...
| **(추가)** StyleGAN Generator 추가 학습 (CNN idea)         | 04.14 월 - 04.15 화 (2d) | ```P002-007-Train-Gen```       | ✅  |
| **(추가)** 핵심 속성 값 계산 알고리즘 개선                          | 04.14 월 (1d)           | ```P002-008-Property```        | ✅  |
| **(추가)** StyleGAN Generator 추가 학습 (VAE decoder idea) | 04.15 화 - 04.18 금 (4d) | ```P002-007-Train-Gen```       | ✅  |
...
| 적절한 한국어 LLM 모델 선택 (Google Colab 에서) | 04.17 목 (1d)           |                            | ⬜  |
| SFT 학습 데이터셋 제작                      | 04.17 목 (1d)           | ```P002-011-SFT-Dataset``` | ⬜  |
| Unsloth 실행 시도                       | 04.17 목 (1d)           |                            | ⬜  |
| SFT + LoRA 를 이용한 Fine-Tuning        | 04.18 금 (1d)           | ```P002-012-SFT-LoRA```    | ⬜  |
| RAG 적용                              | 04.18 금 - 04.19 토 (2d) | ```P002-013-RAG```         | ⬜  |
