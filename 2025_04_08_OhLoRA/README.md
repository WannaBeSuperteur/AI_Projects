...
| **(추가)** StyleGAN Generator 추가 학습 (CNN idea)         | 04.13 일 - 04.14 월 (2d) | ```P002-007-Train-Gen```       | 💨 |
| **(추가)** 핵심 속성 값 계산 알고리즘 개선                          | 04.14 월 (1d)           | ```P002-008-Property```        | ⬜  |
| **(추가)** StyleGAN Generator 추가 학습 (VAE decoder idea) | 04.14 월 (1d)           | ```P002-007-Train-Gen```       | 💨 |
| **(추가)** StyleGAN Generator z sampling 오류 수정         | 04.18 금 (1d)           | ```P002-009-Fix-FineTune-v3``` | 💨 |
...
| Unsloth 실행 시도                                      | 04.15 화 (1d)           |                            | ⬜  |
| 적절한 한국어 LLM 모델 선택                                  | 04.15 화 (1d)           |                            | ⬜  |
| SFT 학습 데이터셋 제작                                     | 04.15 화 (1d)           | ```P002-011-SFT-Dataset``` | ⬜  |
| SFT + LoRA 를 이용한 Fine-Tuning                       | 04.15 화 - 04.16 수 (2d) | ```P002-012-SFT-LoRA```    | ⬜  |
| RAG 적용                                             | 04.16 수 - 04.17 목 (2d) | ```P002-013-RAG```         | ⬜  |
