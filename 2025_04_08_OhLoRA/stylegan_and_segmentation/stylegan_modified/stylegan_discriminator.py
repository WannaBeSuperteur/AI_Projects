# Modified implementation from https://github.com/genforce/genforce/blob/master/models/stylegan_discriminator.py
...
class StyleGANDiscriminatorForV4(nn.Module):
    """Defines the discriminator network in StyleGAN.
