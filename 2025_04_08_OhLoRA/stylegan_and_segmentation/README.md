...
* 핵심 속성 값이란?
  * **핵심 속성 값** 은 다음 목적을 위해 사용되는 numeric value 를 말한다.
    ...
    * [오로라 v2](../../2025_05_02_OhLoRA_v2/stylegan/README.md) 및 [오로라 v3](../../2025_05_26_OhLoRA_v3/stylegan/README.md) 의 경우, 이미지 그룹화 등 AI 학습 성능을 높이는 목적으로도 사용
...
| 고개 돌림 ```pose```              | 왼쪽 고개 돌림 (-1), 정면 (0), 오른쪽 고개 돌림 (+1) | $N(0, 1^2)$                                                    | ❌       | ✅ / ✅ / ✅ / ✅                |
