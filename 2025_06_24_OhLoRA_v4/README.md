...
| 📃 문서화   | Segmentation 개발 내용 문서화                                                                                                                                                                                                                                                                                                                                 | 06.26 목 (1d)           |                                    |                                                                    | 💨 |

**3. LLM 의 AI 윤리 강화**

| 구분         | 계획 내용                                                  | 일정           | branch                     | issue | 상태 |
|------------|--------------------------------------------------------|--------------|----------------------------|-------|----|
| 📝 데이터셋 작성 | LLM Supervised Fine-Tuning 학습 데이터 증량 **(AI 윤리 강화)**    | 06.27 금 (1d) |                            |       | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습 **(Oh-LoRA 답변 생성 LLM만)** | 06.27 금 (2d) | ```P007-005-train-LLM```   |       | ⬜  |
