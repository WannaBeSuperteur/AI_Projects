...
| 🛠 사전 작업 | Segmentation 학습 데이터 필터링 (Segmentation 결과의 'noise'가 큰 데이터 제거)                                                                                                                                                                                                                                                                                           | 06.25 수 (1d)           | ```P007-002-Prepare-Data```        | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/31) | 💨 |
