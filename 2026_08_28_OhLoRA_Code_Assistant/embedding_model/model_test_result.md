...
* 모델 교체 전/후: `Giga-Embeddings-instruct-480M-0826` 대신 경량 모델인 `LateOn-Code-pretrain` 로 변경했을 때 전/후 성능 비교
...
![image](../../images/260828_5.PNG)

### 2-3. 변수명, 함수명은 의미가 있어야 함 (+ 알기 쉽게 할것)

![image](../../images/260828_3.PNG)

### 2-4. 함수명과 반환값이 서로 잘 match 되어야 함

![image](../../images/260828_4.PNG)
...
![image](../../images/260828_7.PNG)

### 2-8. 함수의 인자가 유동적인 경우 처리 필요

![image](../../images/260828_8.PNG)

### 2-9. 상태 값으로 판단되는 값을 조건으로 하는지 여부

![image](../../images/260828_9.PNG)

### 2-10. 한 모듈 (*.py 파일) 내에서, 유사한 이름의 함수끼리 거리 검사

![image](../../images/260828_10.PNG)
