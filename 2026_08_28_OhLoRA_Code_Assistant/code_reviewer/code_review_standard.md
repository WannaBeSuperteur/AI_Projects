...
* [4. 그 외 Pythonic 한 프로그래밍](#4-그-외-pythonic-한-프로그래밍)
* [5. 예외 및 오류 처리](#5-예외-및-오류-처리)
* [6. 코드 응집성, 클래스화 등](#6-코드-응집성-클래스화-등)
...
* 함수형 도구 사용 권장
  ...
  * `filter`
  * `reduce`
* `if-elif-else` 가 반복되는 경우 `dict` 를 이용하여 단순화
