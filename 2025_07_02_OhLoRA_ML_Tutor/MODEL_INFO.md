...
| [Segmentation Model for Oh-LoRA v4](../2025_06_24_OhLoRA_v4/segmentation/README.md#1-segmentation-방법)                                                      | Oh-LoRA 👱‍♀️ (오로라) 얼굴에 **Ombre 헤어스타일 적용**                                                                                                                                                                                                             | [HuggingFace](https://huggingface.co/daebakgazua/250624_OhLoRA_Hair_Segmentation/tree/main) > ```segmentation_model_ohlora_v4.pth``` | ```segmentation/models``` 경로에 원래 이름 그대로 저장                   | 
