...
| 🧪 모델 학습   | 답안 해설용 LLM Supervised Fine-Tuning 학습<br>(LLM: **Kanana** by Kakao) | 07.12 토 (1d)           | ```P008-005-train-LLM2```   |                                                                    | ⬜  |
| 🧪 모델 학습   | 답안 해설용 LLM Supervised Fine-Tuning 학습<br>(LLM: **믿:음 2.0** by KT)   | 07.12 토 (1d)           | ```P008-005-train-LLM2```   |                                                                    | ⬜  |
