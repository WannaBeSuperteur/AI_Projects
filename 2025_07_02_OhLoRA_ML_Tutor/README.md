...
* 전체 일정 : **2025.07.02 수 - 07.16 수 (15 days)**
...
| 🔍 최종 검토 | 최종 사용자 실행용 코드 작성 **(기본 뼈대)**        | 07.15 화 (1d) | ```P008-009-ForUser``` |       | ⬜  |
| 🔍 최종 검토 | 최종 사용자 실행용 코드 작성 **(머신러닝 분야 질의응답)** | 07.15 화 (1d) | ```P008-009-ForUser``` |       | ⬜  |
| 🔍 최종 검토 | 최종 사용자 실행용 코드 작성 **(머신러닝 분야 퀴즈)**   | 07.15 화 (1d) | ```P008-009-ForUser``` |       | ⬜  |
| 🔍 최종 검토 | 최종 사용자 실행용 코드 작성 **(멀티턴 실전 면접)**    | 07.15 화 (1d) | ```P008-009-ForUser``` |       | ⬜  |
| 🔍 최종 검토 | 최종 QA (버그 유무 검사)                    | 07.16 수 (1d) |                        |       | ⬜  |
| 📃 문서화   | 데이터셋 및 모델 HuggingFace 에 등록          | 07.16 수 (1d) |                        |       | ⬜  |
| 📃 문서화   | 프로젝트 문서 정리 및 마무리                    | 07.16 수 (1d) |                        |       | ⬜  |
...
| 🧪 모델 학습   | 답안 해설용 LLM Supervised Fine-Tuning 학습<br>(LLM: **Kanana** by Kakao) | 07.12 토 (1d)           | ```P008-005-train-LLM2```   | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/41) | 💨 |
| 🧪 모델 학습   | 답안 해설용 LLM Supervised Fine-Tuning 학습<br>(LLM: **믿:음 2.0** by KT)   | 07.12 토 (1d)           | ```P008-005-train-LLM2```   | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/41) | 💨 |
| ⚙ 기능 구현    | 틀릴 가능성이 높은 퀴즈 출제 구현                                                | 07.12 토 (1d)           | ```P008-006-fit-quiz```     |                                                                    | ⬜  |
| 📃 문서화     | "머신러닝 분야 퀴즈" 개발 내용 문서화                                             | 07.12 토 (1d)           |                             |                                                                    | ⬜  |

**4. 멀티턴 실전 면접 기능**

| 구분         | 계획 내용                                                                         | 일정           | branch                           | issue | 상태 |
|------------|-------------------------------------------------------------------------------|--------------|----------------------------------|-------|----|
| 📝 데이터셋 작성 | LLM Supervised Fine-Tuning 학습 데이터 작성 **(면접관 발화 생성 & 직전 대화 요약 LLM)**           | 07.13 일 (2d) | ```P008-006-interview-dataset``` |       | ⬜  |
| 🔨 모델 구현   | RAG 유사 컨셉 구현 (멀티턴 실전 면접 기능용)                                                  | 07.13 일 (1d) | ```P008-007-train-LLM3-1```      |       | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습<br>(**면접관 발화 생성** LLM, RAG 유사 컨셉 / **Kanana**)  | 07.13 일 (1d) | ```P008-007-train-LLM3-1```      |       | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습<br>(**면접관 발화 생성** LLM, RAG 유사 컨셉 / **믿:음 2.0**) | 07.13 일 (1d) | ```P008-007-train-LLM3-1```      |       | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습<br>(**직전 대화 요약** LLM / **Kanana**)              | 07.14 월 (1d) | ```P008-008-train-LLM3-2```      |       | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습<br>(**직전 대화 요약** LLM / **믿:음 2.0**)             | 07.14 월 (1d) | ```P008-008-train-LLM3-2```      |       | ⬜  |
| 📃 문서화     | "멀티턴 실전 면접" 개발 내용 문서화                                                         | 07.14 월 (1d) |                                  |       | ⬜  |
