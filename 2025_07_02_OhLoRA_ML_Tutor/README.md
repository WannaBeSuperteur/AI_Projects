...
* 전체 일정 : **2025.07.02 수 - 07.12 토 (11 days)**
...
| 🧪 모델 학습   | 답안 해설용 LLM Supervised Fine-Tuning 학습 **(Kanana)**  | 07.09 수 (1d)           | ```P008-005-train-LLM2```   |                                                                    | ⬜  |
| 🧪 모델 학습   | 답안 해설용 LLM Supervised Fine-Tuning 학습 **(믿:음 2.0)** | 07.09 수 (1d)           | ```P008-005-train-LLM2```   |                                                                    | ⬜  |
...
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습 (**면접관 발화 생성** LLM, RAG 유사 컨셉 / **Kanana**)  | 07.10 목 (1d)           | ```P008-007-train-LLM3-1```      |       | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습 (**면접관 발화 생성** LLM, RAG 유사 컨셉 / **믿:음 2.0**) | 07.10 목 (1d)           | ```P008-007-train-LLM3-1```      |       | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습 (**직전 대화 요약** LLM / **Kanana**)              | 07.11 금 (1d)           | ```P008-008-train-LLM3-2```      |       | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습 (**직전 대화 요약** LLM / **믿:음 2.0**)             | 07.11 금 (1d)           | ```P008-008-train-LLM3-2```      |       | ⬜  |
