...
| 📝 데이터셋 작성 | LLM Supervised Fine-Tuning 학습 데이터 작성 **(질의응답 LLM, RAG 유사 컨셉)**     | 07.04 금 - 07.05 토 (2d) | ```P008-002-train-LLM1-RAG``` | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/38) | 💨 |
