...
* 전체 일정 : **2025.07.02 수 - 07.11 금 (10 days)**
...
| 🔍 최종 검토 | 최종 사용자 실행용 코드 작성 **(머신러닝 분야 질의응답)** | 07.10 목 (1d) | ```P008-009-ForUser``` |       | ⬜  |
| 🔍 최종 검토 | 최종 사용자 실행용 코드 작성 **(머신러닝 분야 퀴즈)**   | 07.10 목 (1d) | ```P008-009-ForUser``` |       | ⬜  |
...
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습 **(질의응답 LLM, w/o RAG 유사 컨셉)**        | 07.02 수 - 07.03 목 (2d) | ```P008-001-train-LLM1```     | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/37) | ✅  |
| 📝 데이터셋 작성 | RAG 학습 데이터 작성 **(질의응답 LLM, RAG 유사 컨셉)**                            | 07.04 금 (1d)           | ```P008-002-train-LLM1-RAG``` | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/38) | 💨 |
| 📝 데이터셋 작성 | LLM Supervised Fine-Tuning 학습 데이터 작성 **(질의응답 LLM, RAG 유사 컨셉)**     | 07.04 금 - 07.05 토 (1d) | ```P008-002-train-LLM1-RAG``` | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/38) | 💨 |
| 🔨 모델 구현   | RAG 유사 컨셉 구현 (질의응답 LLM 용)                                          | 07.05 토 (1d)           | ```P008-002-train-LLM1-RAG``` | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/38) | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습 **(질의응답 LLM, RAG 유사 컨셉)**            | 07.05 토 (1d)           | ```P008-002-train-LLM1-RAG``` | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/38) | ⬜  |
| 📃 문서화     | "머신러닝 분야 질의응답" 개발 내용 문서화                                           | 07.04 금 - 07.05 토 (2d) |                               |                                                                    | 💨 |

**3. 머신러닝 분야 퀴즈 기능**

| 구분         | 계획 내용                                | 일정                     | branch                      | issue | 상태 |
|------------|--------------------------------------|------------------------|-----------------------------|-------|----|
| 📝 데이터셋 작성 | "머신러닝 분야 퀴즈" 학습 데이터 작성               | 07.05 토 - 07.06 일 (2d) | ```P008-003-quiz-dataset``` |       | ⬜  |
| 🧪 모델 학습   | 사용자 답변 채점용 S-BERT 모델 학습              | 07.06 일 (1d)           | ```P008-004-train-SBERT2``` |       | ⬜  |
| 🧪 모델 학습   | 답안 해설용 LLM Supervised Fine-Tuning 학습 | 07.08 화 (1d)           | ```P008-005-train-LLM2```   |       | ⬜  |
| ⚙ 기능 구현    | 틀릴 가능성이 높은 퀴즈 출제 구현                  | 07.08 화 (1d)           | ```P008-006-fit-quiz```     |       | ⬜  |
| 📃 문서화     | "머신러닝 분야 퀴즈" 개발 내용 문서화               | 07.08 화 (1d)           |                             |       | ⬜  |
...
| 🔨 모델 구현   | RAG 유사 컨셉 구현 (멀티턴 실전 면접 기능용)                                        | 07.09 수 (1d)           | ```P008-007-train-LLM3-1```      |       | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습 **(면접관 발화 생성 LLM, RAG 유사 컨셉)**        | 07.09 수 (1d)           | ```P008-007-train-LLM3-1```      |       | ⬜  |
...
| 핵심 기능        | 사용 기술                 | 구성 모델                                    |
|--------------|-----------------------|------------------------------------------|
| 머신러닝 분야 질의응답 | LLM **(Single-turn)** | - 질의응답 모델 (LLM) 1개                       |
| 머신러닝 분야 퀴즈   | LLM, S-BERT           | - 사용자 답변 채점 S-BERT 모델 1개<br>- 해설용 LLM 1개 |
