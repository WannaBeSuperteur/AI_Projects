...
| 구분         | 계획 내용                                               | 일정                     | branch                    | issue                                                              | 상태 |
|------------|-----------------------------------------------------|------------------------|---------------------------|--------------------------------------------------------------------|----|
| 📝 데이터셋 작성 | LLM Supervised Fine-Tuning 학습 데이터 작성 **(질의응답 LLM)** | 07.02 수 - 07.04 금 (3d) | ```P008-001-train-LLM1``` | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/37) | 💨 |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습 **(질의응답 LLM)**        | 07.04 금 (1d)           | ```P008-001-train-LLM1``` | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/37) | 💨 |
