...
* 전체 일정 : **2025.07.02 수 - 07.26 토 (25 days)**
...
| 🔍 최종 검토 | 최종 사용자 실행용 코드 작성 **(기본 뼈대)**        | 07.25 금 (1d) | ```P008-010-ForUser``` |       | ⬜  |
| 🔍 최종 검토 | 최종 사용자 실행용 코드 작성 **(머신러닝 분야 질의응답)** | 07.25 금 (1d) | ```P008-010-ForUser``` |       | ⬜  |
| 🔍 최종 검토 | 최종 사용자 실행용 코드 작성 **(머신러닝 분야 퀴즈)**   | 07.25 금 (1d) | ```P008-010-ForUser``` |       | ⬜  |
| 🔍 최종 검토 | 최종 사용자 실행용 코드 작성 **(멀티턴 실전 면접)**    | 07.25 금 (1d) | ```P008-010-ForUser``` |       | ⬜  |
| 🔍 최종 검토 | 최종 QA (버그 유무 검사)                    | 07.26 토 (1d) |                        |       | ⬜  |
| 📃 문서화   | 데이터셋 및 모델 HuggingFace 에 등록          | 07.26 토 (1d) |                        |       | ⬜  |
| 📃 문서화   | 프로젝트 문서 정리 및 마무리                    | 07.26 토 (1d) |                        |       | ⬜  |
...
| 🔨 모델 구현   | RAG 유사 컨셉 구현 (멀티턴 실전 면접 기능용)                                                  | 07.23 수 (1d)           | ```P008-008-train-LLM3-1```      |                                                                    | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습<br>(**면접관 발화 생성** LLM, RAG 유사 컨셉 / **Kanana**)  | 07.23 수 (1d)           | ```P008-008-train-LLM3-1```      |                                                                    | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습<br>(**면접관 발화 생성** LLM, RAG 유사 컨셉 / **믿:음 2.0**) | 07.23 수 (1d)           | ```P008-008-train-LLM3-1```      |                                                                    | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습<br>(**직전 대화 요약** LLM / **Kanana**)              | 07.24 목 (1d)           | ```P008-009-train-LLM3-2```      |                                                                    | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습<br>(**직전 대화 요약** LLM / **믿:음 2.0**)             | 07.24 목 (1d)           | ```P008-009-train-LLM3-2```      |                                                                    | ⬜  |
| 📃 문서화     | "멀티턴 실전 면접" 개발 내용 문서화                                                         | 07.24 목 (1d)           |                                  |                                                                    | ⬜  |
