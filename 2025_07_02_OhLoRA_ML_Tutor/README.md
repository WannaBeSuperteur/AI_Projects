...
| 📝 데이터셋 작성 | RAG 학습 데이터 작성 **(질의응답 LLM, RAG 유사 컨셉)**                            | 07.04 금 (1d)           | ```P008-002-train-LLM1-RAG``` |                                                                    | ⬜  |
| 📝 데이터셋 작성 | LLM Supervised Fine-Tuning 학습 데이터 작성 **(질의응답 LLM, RAG 유사 컨셉)**     | 07.04 금 - 07.05 토 (1d) | ```P008-002-train-LLM1-RAG``` |                                                                    | ⬜  |
| 🔨 모델 구현   | RAG 유사 컨셉 구현 (질의응답 LLM 용)                                          | 07.05 토 (1d)           | ```P008-002-train-LLM1-RAG``` |                                                                    | ⬜  |
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습 **(질의응답 LLM, RAG 유사 컨셉)**            | 07.05 토 (2d)           | ```P008-002-train-LLM1-RAG``` |                                                                    | ⬜  |
...
| 구분         | 계획 내용                                | 일정                     | branch                      | issue | 상태 |
|------------|--------------------------------------|------------------------|-----------------------------|-------|----|
| 📝 데이터셋 작성 | AI 퀴즈 학습 데이터 작성                      | 07.05 토 - 07.06 일 (2d) | ```P008-003-quiz-dataset``` |       | ⬜  |
