...
* 그래프 해석
  ...
  * 범례
    ...
    * intermediate vector 추출 방법은 [SVM 방법 문서](../README.md#3-3-stylegan-vectorfind-v9-svm-방법), [Gradient 방법 문서](../README.md#3-4-stylegan-vectorfind-v9-gradient-방법) 참고
