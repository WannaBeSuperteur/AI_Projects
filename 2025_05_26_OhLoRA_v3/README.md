...
| 🧪 모델 학습 | '곱슬머리 or 직모' 핵심 속성 값 예측 CNN 개발 및 학습                                                                                                               | 05.27 화 - 05.28 수 (2d) | ```P005-003-Hairstyle```              | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/16) | ⬜  |
| 🛠 사전 작업 | '곱슬머리 or 직모' 핵심 속성 값 예측 CNN 을 기존 [Property Score CNN](../2025_04_08_OhLoRA/stylegan_and_segmentation/README.md#3-3-cnn-model-나머지-핵심-속성-값-7개) 과 결합 | 05.28 수 (1d)           | ```P005-003-Hairstyle```              | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/16) | ⬜  |
