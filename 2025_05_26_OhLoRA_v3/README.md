...
| 🔍 최종 검토 | 최종 사용자 실행용 코드 작성           | 06.03 화 (1d) | ```P005-012-ForUser``` |       | ⬜  |
| 🔍 최종 검토 | 최종 QA (버그 유무 검사)           | 06.03 화 (1d) |                        |       | ⬜  |
...
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습 **(2차, 오로라 답변 LLM 1개, LoRA rank=16, 실험 목적)**                         | 06.02 월 - 06.03 화 (2d) | ```P005-011-train-LLM-rank16``` |                                                                    | ⬜  |
