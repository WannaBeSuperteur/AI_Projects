...
| 🧪 모델 학습 | StyleGAN-FineTune-v8 에서 핵심 속성 값만 변화시키는 vector 추출 학습 및 성능 테스트                                                                                      | 05.29 목 - 05.30 금 (2d) | ```P005-005-StyleGAN-VectorFind-v8``` | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/18) | ⬜  |
