...
| 🔍 최종 검토 | 최종 QA (버그 유무 검사)           | 06.04 수 (1d)           |                        |                                                                    | ⬜  |
...
| 🧪 모델 학습   | LLM Supervised Fine-Tuning 학습 **(3차, [Kanana instruct LLM](https://huggingface.co/kakaocorp/kanana-1.5-2.1b-instruct-2505) 으로 모델 2개, 실험 목적)** | 06.04 수 (1d)           | ```P005-013-train-LLM-instruct``` | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/26) | 💨 |
