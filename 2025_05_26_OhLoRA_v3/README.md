...
| 🧪 모델 개선   | S-BERT (화제 전환 여부 파악) 학습 (Pre-trained S-BERT 기반)                                                    | 06.01 일 (1d)           | ```P005-010-SBERT-topic```      |                                                                    | ⬜  |
| 📝 데이터셋 작성 | BERT (부적절한 언어 여부 파악) 학습 데이터 작성                                                                     | 06.02 월 (1d)           | ```P005-011-BERT-ethics```      |                                                                    | ⬜  |
| 🧪 모델 학습   | BERT (부적절한 언어 여부 파악) 학습 (Pre-trained BERT 기반)                                                      | 06.02 월 (1d)           | ```P005-011-BERT-ethics```      |                                                                    | ⬜  |
