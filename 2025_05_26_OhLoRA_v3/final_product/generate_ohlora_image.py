...
def generate_images(vectorfind_v8_generator, ohlora_z_vector, eyes_vector, mouth_vector, pose_vector,
    ...
    code_part2 = torch.tensor(code_part2_np).unsqueeze(0).to(torch.float32)  # 7
    ...
    with torch.no_grad():
        ...
        images = generate_image_using_w(vectorfind_v8_generator, code_w_)
