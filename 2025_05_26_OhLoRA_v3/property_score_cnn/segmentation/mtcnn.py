...
class PNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            pnet_path = f'{PROJECT_DIR_PATH}/property_score_cnn/models/mtcnn_pnet.pt'
...
class RNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            rnet_path = f'{PROJECT_DIR_PATH}/property_score_cnn/models/mtcnn_rnet.pt'
...
class ONet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            onet_path = f'{PROJECT_DIR_PATH}/property_score_cnn/models/mtcnn_onet.pt'
