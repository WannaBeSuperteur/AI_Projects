...
* 성능 보고서
  * [StyleGAN-FineTune-v8 학습 결과 보고서](stylegan_finetune_v8/train_report.md)
...
* 요약
  ...
  * StyleGAN 에서 **latent vector (z)** 가 mapping 된 **intermediate vector (w)** 를 이용하여 핵심 속성 값을 변화 [(설명 이미지)](../../images/OhLoRA_VectorFind_common.png)
