...
def create_model_structure_pdf(finetune_v1_generator):
    save_model_structure_pdf(finetune_v1_generator,
                             model_name='finetune_v1_generator_for_v6',
...
# Returns:
# - stylegan/stylegan_vectorfind_v6/inference_test_before_finetuning 에 생성 결과 저장

def run_inference_test_before_training(finetune_v1_generator):
    kwargs_val = dict(trunc_psi=1.0, trunc_layers=0, randomize_noise=False)
    finetune_v1_generator.G_kwargs_val = kwargs_val

    img_save_dir = f'{PROJECT_DIR_PATH}/stylegan/stylegan_vectorfind_v6/inference_test_before_training'
