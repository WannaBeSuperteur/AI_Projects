...
def sample_w_and_compute_property_scores(finetune_v1_generator, property_score_cnn, n=10000):
...
def extract_best_and_worst_k_images(property_scores, ratio=0.20):
