...
| StyleGAN 구조 추가 변경 (탐독한 논문 참고)                                                                                                                      | 05.04 일 (1d)           | ```P003-003-StyleGAN```                   | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/1) | ⬜  |
| StyleGAN 학습 데이터 Augmentation                                                                                                                       | 05.04 일 - 05.05 월 (2d) | ```P003-004-Augment```                    |                                                                   | ⬜  |
| StyleGAN 학습                                                                                                                                        | 05.05 월 - 05.06 화 (2d) | ```P003-005-StyleGAN-Train```             |                                                                   | ⬜  |
| LLM Supervised Fine-Tuning 학습 데이터 증량                                                                                                               | 05.05 월 (1d)           |                                           |                                                                   | ⬜  |
| [KoreamLM (by QuantumAI)](https://huggingface.co/quantumaikr/KoreanLM) Fine-Tuning 시도                                                              | 05.06 화 (1d)           | ```P003-006-KoreanLM```                   |                                                                   | ⬜  |
| S-BERT (for memory) 학습 데이터 증량 및 품질 향상                                                                                                              | 05.06 화 (1d)           |                                           |                                                                   | ⬜  |
| S-BERT (for memory) ground-truth similarity score 계산 고도화                                                                                           | 05.06 화 (1d)           | ```P003-007-SBERT-sim```                  |                                                                   | ⬜  |
| 하고 있는 대화 요약을 S-BERT (for memory) 와 연동                                                                                                              | 05.07 수 (1d)           | ```P003-008-SBERT-current-conversation``` |                                                                   | ⬜  |              
| S-BERT (for memory) 임베딩 방법 개선 연구                                                                                                                   | 05.07 수 - 05.08 목 (2d) | ```P003-009-SBERT-embedding```            |                                                                   | ⬜  |
| 답변 생성 시도 및 성공/실패 처리 메커니즘 개선                                                                                                                        | 05.08 목 (1d)           | ```P003-010-Answer```                     |                                                                   | ⬜  |
| 실시간 표정 변화 적용                                                                                                                                       | 05.08 목 (1d)           | ```P003-011-Realtime```                   |                                                                   | ⬜  |
| 최종 사용자 실행용 코드 작성                                                                                                                                   | 05.08 목 (1d)           | ```P003-012-ForUser```                    |                                                                   | ⬜  |
