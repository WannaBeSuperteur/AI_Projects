...
| **(추가)** StyleGAN Discriminator 의 출력값을 Property Score 차이를 이용하는 것으로 수정                                                                              | 05.04 일 - 05.05 월 (2d) | ```P003-008-StyleGAN-dis```               | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/1) | 💨 |
| StyleGAN 구조 추가 변경 (탐독한 논문 참고)                                                                                                                      | 05.05 월 (1d)           | ```P003-006-StyleGAN```                   | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/1) | 💨 |
| StyleGAN 학습                                                                                                                                        | 05.05 월 (1d)           | ```P003-009-StyleGAN-Train```             |                                                                   | ⬜  |
