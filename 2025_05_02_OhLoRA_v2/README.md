...
| **(추가)** StyleGAN 학습 (구조 추가 변경 이전, Gender CNN 구조 유/무 각각)                                                                                           | 05.04 일 - 05.05 월 (2d) |                                           | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/1) | 💨 |
...
| StyleGAN 학습 (추가 변경된 버전)                                                                                                                            | 05.05 월 (1d)           | ```P003-009-StyleGAN-Train```             |                                                                   | ⬜  |
