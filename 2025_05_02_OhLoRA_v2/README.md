...
| StyleGAN 구조 추가 변경 (탐독한 논문 참고)                                                                                                                      | 05.04 일 (1d)           | ```P003-006-StyleGAN```                   | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/1) | 💨 |
| StyleGAN 학습                                                                                                                                        | 05.04 일 - 05.05 월 (2d) | ```P003-007-StyleGAN-Train```             |                                                                   | ⬜  |
