...
* 전체 일정 : **2025.05.02 금 - 05.19 월 (18d)**
...
| 🔍 최종 검토 | 최종 사용자 실행용 코드 작성                                | 05.18 일 - 05.19 월 (2d) | ```P003-017-ForUser```  |       | ⬜  |
| ⚙ 기능 개선  | 최종 사용자 실행용 코드 작성 시, 답변 생성 시도 및 성공/실패 처리 메커니즘 개선 | 05.19 월 (1d)           | ```P003-017-ForUser```  |       | ⬜  |
| 🔍 최종 검토 | 최종 QA (버그 유무 검사)                                | 05.19 월 (1d)           |                         |       | ⬜  |
| 📃 문서화   | 프로젝트 문서 정리 및 마무리                                | 05.19 월 (1d)           |                         |       | ⬜  |
...
| 🔨 모델 개선 | StyleGAN 핵심 속성 변화 vector 추출 위치 변경 (latent z space 대신 w space 에서)                                                                                   | 05.15 목 - 05.18 일 (4d) | ```P003-016-StyleGAN-VectorFind-w```     | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/8) | 💨 |
| 📃 문서화   | StyleGAN 개발 내용 문서화 **(2차)**                                                                                                                        | 05.16 금 - 05.18 일 (3d) |                                          |                                                                   | 💨 |
