...
| StyleGAN 구조 추가 변경 (탐독한 논문 참고)                                                                                                                      | 05.04 일 - 05.05 월 (2d) | ```P003-006-StyleGAN```                   | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/1) | 💨 |
| StyleGAN 학습                                                                                                                                        | 05.05 월 (1d)           | ```P003-008-StyleGAN-Train```             |                                                                   | ⬜  |
| **(추가)** StyleGAN 에서 핵심 속성 값만 변화시키는 vector 추출 방법 논문 탐독 ([참고 논문](https://arxiv.org/pdf/1911.09267))                                                 | 05.04 일 - 05.05 월 (2d) |                                           |                                                                   | 💨 |
