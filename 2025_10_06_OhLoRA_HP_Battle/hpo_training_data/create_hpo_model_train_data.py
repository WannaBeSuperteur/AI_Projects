...
def generate_constraints(dataset_name):
    if dataset_name == 'cifar_10':
        ...
        val_left, val_range_size = random.randint(16, 112), random.randint(8, 80)
        std_left, std_range_size = random.randint(32, 96), random.randint(8, 48)

        constraints = {'value': [val_left, val_left + val_range_size],
                       'std': [std_left, std_left + std_range_size]}

    else:  # mnist
        val_left, val_range_size = random.randint(16, 48), random.randint(8, 48)
        std_left, std_range_size = random.randint(64, 96), random.randint(8, 32)
