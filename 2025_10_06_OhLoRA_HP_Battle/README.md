...
* 전체 일정 : **2025.10.06 월 - 10.11 토 + 2026.03.15 일 - 06.04 목**
...
| 🔍 최종 검토 | 최종 QA (버그 유무 검사)           | 06.03 수 (1d)           |                        |       | ⬜  |
| 📃 문서화   | 데이터셋 및 모델 HuggingFace 에 등록 | 06.04 목 (1d)           |                        |       | ⬜  |
| 📃 문서화   | 프로젝트 문서 정리 및 마무리           | 06.04 목 (1d)           |                        |       | ⬜  |
...
| 구분       | 계획 내용                                                                                                                                       | 일정                     | branch                       | issue                                                              | 상태 |
|----------|---------------------------------------------------------------------------------------------------------------------------------------------|------------------------|------------------------------|--------------------------------------------------------------------|----|
| 🧪 모델 학습 | 대결 결과 표현 LLM Supervised Fine-Tuning 학습<br>(LLM: [Kanana-1.5 2.1B Instruct](https://huggingface.co/kakaocorp/kanana-1.5-2.1b-instruct-2505)) | 05.31 일 - 06.03 수 (4d) | ```P009-009-train-LLM```     | [issue](https://github.com/WannaBeSuperteur/AI_Projects/issues/54) | 💨 |
| ⚙ 기능 구현  | 대결 결과 리스트 기반 결과 표현 출력 구현                                                                                                                    | 06.03 수 (1d)           | ```P009-010-battle-result``` |                                                                    | ⬜  |
