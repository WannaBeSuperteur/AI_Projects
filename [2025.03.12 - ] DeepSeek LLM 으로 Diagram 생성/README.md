...
| LLM Fine-tuning 학습 데이터의 Diagram 생성 알고리즘 개발 | 03.14 금 (1d)           | ```P001-001-DiagAlgo``` | ⬜  |
| LLM Fine-tuning 학습 데이터 생성                  | 03.14 금 (1d)           | ```P001-002-FineTune``` | ⬜  |
| LLM Fine-tuning 실시                         | 03.15 토 (1d)           | ```P001-002-FineTune``` | ⬜  |
