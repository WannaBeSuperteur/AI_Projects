...
* [2. 각 모델 별 Hugging Face 원본 모델 경로](#2-각-모델-별-hugging-face-원본-모델-경로)
  ...
  * [2-6. Oh-LoRA Hyper-param Battle](#2-6-oh-lora-hyper-param-battle)
...
* **[참고] Fine-Tuned LLM 폴더** 에 해당하는 디렉토리가 git clone 시에 초기에 없을 때는 먼저 해당 폴더를 생성한 후 진행합니다.
...
### 2-6. [Oh-LoRA Hyper-param Battle](2025_10_06_OhLoRA_HP_Battle)

* Fine-Tuned LLM 폴더
  * ```llm/models/kananai_sft_final_fine_tuned```
